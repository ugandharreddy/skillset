							...
							<table class="table table_center1 table-bordered table-hover"
								...
								<tbody>
										...
										<c:forEach items="${coreSkills}" var="coreSkills"
											...
											<tr>
											<form:form
												action="${pageContext.request.contextPath}/reviewSkillBySME/${empID}/${coreSkills.proficiencyId}"
											...
											<td><div class="col-xs-6">
											 <form:input path="expYears"  class="form-control"  type="hidden" value='${coreSkills.expYears}'/>${coreSkills.expYears} Yr(s)</div>
											<div class="col-xs-6">
											...
											<%-- <form:input path="empRating" readonly="true" value="${coreSkills.empRating}" class="form-control"></form:input> --%>
													...
													<td>${coreSkills.plComment}</td>

													<td><form:select class="form-control" path="mgrRating"
															id="techratingSME" onchange="SMEDisabledTech($(this));">
							...
							<table class="table table-bordered table-hover" id="tab_logic">
								...
								<tbody>
									...
									<tr id="${countIndex.index}">
										 <form:form
											action="${pageContext.request.contextPath}/reviewDomainBySME/${empID}/${domain.domainName}/${domain.proficiencyId}"
...
<c:if test="${domain.isPrime =='Y'}">
												...
												<%-- <form:input path="sGroup" readonly="true" value="${domain.sGroup}" class="form-control"></form:input> --%>
												 <form:input path="dName"  class="form-control"  type="hidden" value='${domain.domainName}'/>${domain.domainName}
												</td>
												<td>
												<div class="col-xs-6">
											...
											<div class="col-xs-6">
											 <form:input path="dExpMonths"  class="form-control"  type="hidden" value='${domain.dExpMonths}'/>${domain.dExpMonths} Mn(s)</div>
												...
												<td>${domain.mgrComment}</td>
												<td>${domain.plComment}</td>
												<td><form:select class="form-control" path="mgrRating"
														id="domainRatingSME"
